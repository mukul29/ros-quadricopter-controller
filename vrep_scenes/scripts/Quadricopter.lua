function sysCall_init() 
    ...
    if (not pluginNotFound) then
        ...
        local visionSensorTopicName='visionSensor'..sysTime
        ...
        visionSensorPub=simROS.advertise('/'..visionSensorTopicName, 'sensor_msgs/Image')
        simROS.publisherTreatUInt8ArrayAsString(visionSensorPub)
